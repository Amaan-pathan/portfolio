...
I'm <strong>Pathan Amaan</strong>, a <span>{age}</span> year old
    ...
    <br />
    <br />
    I have worked as an <strong>open-source contributor</strong> with organizations like <strong>Zulip</strong>, 
    where I improved features and enhanced the user experience. I’m also the <strong>President</strong> of <strong>Shark Sphere</strong>, 
    an E-Cell at <strong>Newton School of Technology</strong>, where I lead entrepreneurial initiatives and build startup-centric platforms for students.
    <br />
